...
public class Configuration {
	...
	public static ModConfigSpec.DoubleValue WATERWHEELS_SOURCE_STRESS_PENALTY;
	public static ModConfigSpec.IntValue WATERWHEELS_SOURCE_THRESHOLD;
	public static ModConfigSpec.IntValue WATERWHEELS_SOURCE_RANGE;
